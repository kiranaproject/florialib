...
// Low-level buffer blur procedures
procedure FloriaFastBlurRoundedRect(buf: Pointer; bufWidth, bufHeight: Integer;
                                    rx, ry, rw, rh: Integer;
                                    cornerRadius: Double; blurRadius: Double);

procedure FloriaFastBlurRect(buf: Pointer; bufWidth, bufHeight: Integer;
                             rx, ry, rw, rh: Integer;
                             blurRadius: Double);

// TFloriaImage convenience overloads
procedure FloriaFastBlur(AImage: TFloriaImage; const rx, ry, rw, rh: Integer;
                         const cornerRadius: Double; const blurRadius: Double); overload;

procedure FloriaFastBlur(AImage: TFloriaImage; const blurRadius: Double); overload;
...
procedure FloriaFastBlurRect(buf: Pointer; bufWidth, bufHeight: Integer;
                             ...
                             blurRadius: Double);
begin
  FloriaFastBlurRoundedRect(buf, bufWidth, bufHeight, rx, ry, rw, rh, 0.0, blurRadius);
end;
...
procedure FloriaFastBlur(AImage: TFloriaImage; const rx, ry, rw, rh: Integer;
                         const cornerRadius: Double; const blurRadius: Double);
begin
  if not Assigned(AImage) or (AImage.PixelBuffer = nil) then Exit;
  FloriaFastBlurRoundedRect(AImage.PixelBuffer, AImage.Width, AImage.Height,
                            rx, ry, rw, rh, cornerRadius, blurRadius);
end;

procedure FloriaFastBlur(AImage: TFloriaImage; const blurRadius: Double);
begin
  if not Assigned(AImage) or (AImage.PixelBuffer = nil) then Exit;
  FloriaFastBlurRoundedRect(AImage.PixelBuffer, AImage.Width, AImage.Height,
                            0, 0, AImage.Width, AImage.Height, 0.0, blurRadius);
end;
